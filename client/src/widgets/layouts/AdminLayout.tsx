            ...
            <header className="bg-white">
                <div className="container min-h-[70px] grid items-center grid-cols-[230px_auto]">
                    ...
                    <div className="flex items-center gap-8 justify-end">
                        ...
                        <button className="flex items-center gap-4 text-gray transition-colors hover:text-orange-1" onClick={() => adminLogout()} aria-label="Вийти з адмін-панелі">
            ...
            <main className="flex-1 bg-white flex flex-col">
                <div className="container grid grid-cols-[230px_auto] shrink-1 grow-1">
                    ...
                    <div className="bg-[#F5F6FA] p-5">
                        <Suspense fallback={<div className="flex items-center justify-center min-h-[200px] text-gray-400">Завантаження...</div>}>
                            <Outlet />
                        </Suspense>
                    </div>
                </div>
